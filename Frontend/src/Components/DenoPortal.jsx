                ...
                <div className="h-[15rem] w-[27rem]  bg-[#e0e7ff]   flex relative backdrop-blur-sm rounded-lg border-[1px] border-gray-500"  >
                    ...
                    <div className="flex items-center justify-center w-full">
                        <div className="flex text-black flex-col w-full items-center   h-full justify-center">
                            <div className="flex font-bold text-xl xl:text-2xl pb-5 ">
                        ...
                        <div className="h-[0.1px] w-full bg-white text-white "></div>
                            <div className="flex justify-end w-full gap-4 pt-5 pr-5  text-white "> 
                                <button className="p-2 bg-[#FC5664] rounded-lg text-sm pl-3 pr-3 font-medium" onClick={fn}>Cancel</button>
                                <button className="p-2 bg-green-600 rounded-lg text-sm pl-3 pr-3 font-medium" onClick={LoginUser}>Join as User</button>
                                <button className="p-2 bg-green-600 rounded-lg text-sm pl-3 pr-3 font-medium" onClick={LoginSeller}>Join as Shop</button>
                            </div>
                        </div>
