    ...
    <>
      ...
      <div className="flex items-center justify-center w-full">
        ...
        <div className="absolute right-0 top-0 cursor-pointer " >
                    ...
                    <svg className="h-8 w-8 text-black rotate-45  " viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round" onClick={prop}>  <circle cx="12" cy="12" r="10" />  <line x1="12" y1="8" x2="12" y2="16" />  <line x1="8" y1="12" x2="16" y2="12" /></svg>
                    </div>
      </div>
      </div>
      </div>
